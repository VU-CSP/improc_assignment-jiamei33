...
A3) Differential Interference has greater dynamic range of pixel intensities.  
...
#Github wasn't reading the tif file, so I saved it as a jpg to have the image show.
